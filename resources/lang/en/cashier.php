...
return [
    ...
    'validation' => [
        ...
        'order-discount-numeric' => 'Order discount must be a number',
        'order-discount-min' => 'Order discount must be at least 0',
        ...
        'cash-tendered-numeric' => 'Cash tendered must be a number',
    ],
];
